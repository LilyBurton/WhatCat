    ...
    return (
        <div className='container'>
            ...
            <div className="submit-container">
                <div className={action==="Back in the Prowl"?"submit gray":"submit"} onClick={()=>{setAction("Welcome Human!")}}>Sign Up</div>
                <div className={action==="Welcome Human!"?"submit gray":"submit"} onClick={()=>{setAction("Back in the Prowl")}}>Login</div>
            </div>
        </div>
    )
}
